            // 1)Дан массив [1, 2, 3, 4, 5] с помощью метода reduce сделать объект в котором ключ будет
            //  равен элементу массива, а значение (элемент * 100)
            // input: [1, 2, 3, 4, 5]
            // output: {1: 100, 2: 200, 3: 300 ...}

// const inputArray = [1, 2, 3, 4, 5, 15, 100, 333 ];
// const resultObject = inputArray.reduce((acc, currentElement) => {
...
// const items = [
//     { nanme: "Harry Potter", house: "Gryffindor" },
//     { name: "Cedric Diggory", house: "Hufflepuff"},
//     { name: "Tonks", house: "Hufflepuff" },
//     { name: "Ronald Weasley", house: "Grtyffindor"},
...
// const Hufflepuff = items.reduce( (result, items) => {
//     if (items.house === "Hufflepuff") {
...
// console.log("От большего к меньшему:", sortedDescending);

// const numbers = [3, 4, 1, 2, 7];
// const sortedAscending = numbers.slice().sort((a, b) => a - b);

// console.log("От меньшего к большему:", sortedAscending);
